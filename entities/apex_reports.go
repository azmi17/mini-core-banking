...
type RekeningKoranRequest struct {
	...
	PeriodeAwal  string `form:"periode_awal" binding:"required"`
	PeriodeAkhir string `form:"periode_akhir" binding:"required"`
}
...
type NominatifDepositRequest struct {
	TanggalHitung string `form:"tgl_hitung" binding:"required"`
	// Order         string
}
